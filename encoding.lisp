...
(defgeneric encode-object (type object)
  ...
  ;; (:method ((type (eql :boolean)) (obj (eql nil)))
  ;;   (with-element "nil"))
  (:method ((type (eql :integer)) (obj (eql nil)))
    (with-element "nil"))
  (:method ((type (eql :double)) (obj (eql nil)))
    (with-element "nil"))
  (:method ((type (eql :string)) (obj (eql nil)))
    (with-element "nil"))
  (:method ((type (eql :array)) (obj (eql nil)))
    (with-element "nil"))
  (:method ((type (eql :dwim-array)) (obj (eql nil)))
    (with-element "nil"))
  (:method ((type (eql :base64)) (obj (eql nil)))
    (with-element "nil"))
  (:method ((type (eql :time)) (obj (eql nil)))
    (with-element "nil"))
  (:method ((type (eql :struct)) (obj (eql nil)))
    (with-element "nil"))
  (:method ((type (eql :dwim-struct)) (obj (eql nil)))
    (with-element "nil"))
  (:method ((type (eql :null)) (obj (eql nil)))
    (with-element "nil")))
